...
public class RescheduledDownloadReceiver extends ScheduledDownloadReceiver {
	
	private String TAG = "RescheduledDownloadReceiver";
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (networkInfo != null && networkInfo.isConnected()){
			...
			ComponentName receiver = new ComponentName(context, RescheduledDownloadReceiver.class);
